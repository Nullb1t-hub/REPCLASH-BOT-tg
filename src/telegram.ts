...
declare global{interface Window{Telegram?:{WebApp?:{ready():void;expand():void;openTelegramLink?(url:string):void;initData?:string;initDataUnsafe?:{user?:{first_name?:string;username?:string;photo_url?:string;start_param?:string}}}}}}
